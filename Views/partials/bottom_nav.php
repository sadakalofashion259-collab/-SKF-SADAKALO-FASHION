...
<nav class="skf-bnav bottom-nav" aria-label="Bottom navigation">
 ...
 <!-- ── এডমিন লগইন করা থাকলে নোটিফিকেশন এবং স্টাফ রিপোর্ট দেখাবে ── -->
    <?php if (isset($_sbUserRole) && $_sbUserRole === 'admin'): ?>
        <a href="../shop_@invantory/notification_dashboard.php" 
           class="bn-item<?php echo $bnActiveClass('notification'); ?>">
            <span class="bn-icon"><i class="fas fa-bell"></i></span>
            <span class="bn-label">নোটিফিকেশন</span>
        </a>

        <a href="../Sadakalo_staff/sadakalo_staff_dashboard.php" class="bn-item">
            <span class="bn-icon"><i class="fas fa-users"></i></span>
